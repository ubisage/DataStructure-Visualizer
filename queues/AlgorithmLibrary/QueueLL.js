...
QueueLL.prototype.setup = function()
{
	...
	this.cmd("SetForegroundColor", this.headLabelID, "#ffffff");
	...
	this.cmd("SetForegroundColor", this.tailLabelID, "#ffffff");
